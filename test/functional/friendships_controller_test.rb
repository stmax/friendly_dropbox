...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { is_active: @friendship.is_active, participant1_id: @friendship.participant1_id, participant2_id: @friendship.participant2_id }
    end
  ...
  test "should update friendship" do
    put :update, id: @friendship, friendship: { is_active: @friendship.is_active, participant1_id: @friendship.participant1_id, participant2_id: @friendship.participant2_id }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
